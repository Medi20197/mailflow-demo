# MailFlow — démonstration portfolio publique
...
Le workflow `.github/workflows/deploy-pages.yml` compile le dossier `frontend` et le publie automatiquement sur GitHub Pages après chaque envoi sur `main`.

## Technologies

React, TypeScript, Vite et CSS responsive.
